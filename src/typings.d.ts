/* eslint-disable @typescript-eslint/no-explicit-any, @typescript-eslint/no-redundant-type-constituents -- Ambient declarations mirror untyped Obsidian and PDF.js private APIs. */
